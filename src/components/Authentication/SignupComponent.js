        ...
        <div className="FormCenter">
            <form onSubmit={this.handleSubmit} className="FormFields">
                <div className="FormField">
                  ...
                  <input type="email" id="email" className="FormField__Input" required placeholder="Enter your email" name="email" autoComplete="off" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" value={email} onChange={this.handleChange} />
                </div>
                <div className="FormField">
                  <label className="FormField__Label" htmlFor="password">Password</label>
                  <input type="password" id="password" className="FormField__Input" required placeholder="Enter your password" name="password" autoComplete="off" pattern="[A-Za-z][A-Za-z0-9]{6,}" value={password} onChange={this.handleChange} />
                </div>
                <div className="FormField">
                ...
                <div className="FormField">
                    ...
                    {' '}
                    <Link to="/login" className="FormField__Link">Login instead</Link>
                </div>
            </form>
        </div>
    );
